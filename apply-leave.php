...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Teacher | Apply Leave</title>
...
<?php
	$sql = "select rm_lv from tblemployees where id=:id";
	$query = $dbh->prepare($sql);
	$query->bindParam(':id',$empid,PDO::PARAM_STR);
	$query->execute();
	$result=$query->fetch(PDO::FETCH_ASSOC);
	$prv_lv = 33-$result['rm_lv'];
 ?>
<div class="input-field col m6 s12"  style="margin-bottom: 25px;">
  <label for="prev">Previous Leave: <?php echo $prv_lv; ?> </label>
  <p></p>
</div>
...
<div class="input-field col m6 s12" style="margin-bottom: 25px;">
  ...
  <label for="prev">Remaining Leave: <?php echo $result['rm_lv']; ?></label>
  <p></p>
</div>
