...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Teacher | Update Teacher Information</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Update Teacher Information</div>
                    </div>
...
{               ?>
 ...
 <div class="input-field col s12">
  <label for="empcode">Teacher Code</label>
...
<label for="birthdate col">Date of Birth</label>
<div class="input-field col m4 s12">
